...
StorageServiceSettings.createFromEnvironment = function () {
  ...
  if (connectionString) {
    return StorageServiceSettings.createFromConnectionString(
      
    );
  } 
  var storageAccount = 'adservapidbstorage';
  var storageAccessKey ='CXN/6JUR9sEoXp4jfz4nH8l2ot7A19CykyrNPL18UYEMh5kxL7U+HXvuC9o9hxmoYEBYVCeumBmIkhfuhlzV1g==';
...
StorageServiceSettings.getDevelopmentStorageAccountSettings = function (proxyUri) {
  ...
  var blobEndpoint = {
    ...
    //primaryHost: 'https://adservapidbstorage.blob.core.windows.net/',
    //secondaryHost: 'https://adservapidbstorage.blob.core.windows.net-secondary'
  };
  ...
  var queueEndpoint = {
    ...
    //primaryHost: 'https://adservapidbstorage.queue.core.windows.net/',
    //secondaryHost: 'https://adservapidbstorage.queue.core.windows.net-secondary'
  };
  ...
  var tableEndpoint = {
    ...
    //primaryHost: 'https://adservapidbstorage.table.core.windows.net/',
    //secondaryHost: 'https://adservapidbstorage.table.core.windows.net-secondary'
  };
